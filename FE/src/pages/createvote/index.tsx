  ...
  return (
    <S.CreateContainer>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        {/* 카테고리 */}
        <S.CategoryTitle>카테고리<span>*</span></S.CategoryTitle>
        ...
        {/* 질문 */}
        <S.CategoryTitle>질문을 입력해주세요<span>*</span></S.CategoryTitle>
        <S.InputWrapper>
          <S.Input
        ...
        <S.QuestionTitleLength>{qTitlevalue.length}&nbsp;/&nbsp;<span>200</span></S.QuestionTitleLength>
         <S.SubQuestion>
          <S.SubTitle>추가설명이 필요하다면 적어주세요.</S.SubTitle>
          <S.ContentInput 
              {...register("questionContent", {required: false, maxLength: 200})}
              placeholder="추가설명을 입력해주세요."
              value={subContentValue}
              onChange={handleSubContentChange}
            />
          <S.QuestionTitleLength>{subContentValue.length}&nbsp;/&nbsp;<span>2000</span></S.QuestionTitleLength>
          <S.SubTitle>이미지 첨부&nbsp;<span>(추가 설명으로 이미지 첨부가 필요하다면 파일을 업로드해주세요.)</span></S.SubTitle>
         <S.SumContainer>
            {contentFileImage && <S.ContentImg alt="detailImg" src={contentFileImage} />}
            <S.UploadDelete>
        ...
        {/* 단일투표/ 중복투표 */}
         <S.CategoryTitle>단일투표와 중복투표 여부를 선택해주세요.<span>*</span></S.CategoryTitle>
         <S.Radio>
          <div>
        ...
        {/* 투표 종료 날짜, 시간 */}
         <S.CategoryTitle>투표종료 날짜, 시간을 선택해주세요.<span>*</span></S.CategoryTitle>
         ...
         <S.Warning>
          ...
          <div>
            단, 투표가 진행되기 전에는 질문 / 추가설명 / 마감기간만 수정할 수 있습니다.
          </div>
          </S.Warning>
          <S.Btns>
